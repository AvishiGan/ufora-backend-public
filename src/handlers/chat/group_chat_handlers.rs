...
use crate::services::websocket::{RoomState, GroupChatWebsocketExtension};

pub async fn websocket_handler(
    ws: WebSocketUpgrade,
    Extension(websocket_extension): Extension<Arc<GroupChatWebsocketExtension>>,
) -> impl IntoResponse {
    // Upgrade the connection to a websocket connection.
    ws.on_upgrade(|socket| websocket(socket, websocket_extension))
}

async fn websocket(stream: WebSocket, websocket_extension: Arc<GroupChatWebsocketExtension>) {
